<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="PageTwo.aspx.cs" Inherits="MyTechnicalHomework4.PageTwo" %>
...
<div class="row">
  ...
  <div class="col-lg-4 mb-4 mb-lg-0">
    <img
      src="https://assets.petco.com/petco/image/upload/f_auto,q_auto/2976429-center-1"
      class="w-100 shadow-1-strong rounded mb-4"
      alt="Ivermectin"
    />

    <img
      src="https://s.turbifycdn.com/aah/yhst-135855760451349/selegiline-5mg-per-capsules-34.jpg"
      class="w-100 shadow-1-strong rounded mb-4"
      alt="Selegiline"
    />
  </div>
